...
import { InterestTimelinePage } from '../interest-timeline/interest-timeline';
...
export class TabsPage {
  ...
  // friends: any = SearchPeoplePage;
  friends: any = HomePage;
  // profile: any = HomePage;
  profile: any = RoomPage;
  
  
  timeline: any = TimelinePage;
  interestTimeline: any = InterestTimelinePage;
  photo : any = ManagePhotoPage;
